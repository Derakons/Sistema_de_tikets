...
<head>
    ...
    <style>
        ...
        .etapa.actual .etapa-icono {
            background-color: white;
            border-color: var(--primary-color);
            color: var(--primary-color);
        }
        
        .etapa.actual .etapa-texto {
            color: var(--primary-color);
            font-weight: 600;
        }
        ...
        .detalle-expandible.activo .detalle-content {
            display: block;
        }
...
<body>
    ...
    <div class="container-main">
        ...
        <form action="seguimiento.php" method="GET" class="search-form">
            ...
            <div class="ticket-card">
                ...
                <div class="ticket-body">
                    ...
                    <div class="action-buttons">
                        ...
                        <?php if ($ticket_info['estado'] == 'Resuelto' || $ticket_info['estado'] == 'Cerrado'): ?>
                        <a href="imprimir_informe.php?ticket_id=<?php echo htmlspecialchars($ticket_info['id']); ?>" target="_blank" class="btn btn-success">
                            <i class="fas fa-file-alt"></i> Ver Informe Completo
                        </a>
                        <?php endif; ?>
                        <a href="index.php" class="btn btn-outline no-print">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Funcionalidad para los detalles expandibles
            const detallesExpandibles = document.querySelectorAll('.detalle-expandible');
            detallesExpandibles.forEach(function(detalle) {
                const header = detalle.querySelector('.detalle-header');
            ...
            // Auto-expandir el primer detalle
            if (detallesExpandibles.length > 0) {
                detallesExpandibles[0].classList.add('activo');
                const icono = detallesExpandibles[0].querySelector('.detalle-header i');
                if (icono) {
                    icono.className = 'fas fa-chevron-up';
                }
            }
